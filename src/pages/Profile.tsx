...
const Profile = () => {
  ...
  return (
    <div className="w-screen h-screen flex flex-col font-raleway text-(--text) relative items-center">
      ...
      <div className="xxlg:w-290 xlg:w-250 lg:w-220 sm:w-150 h-180 bg-(--bg) mt-30 shadow-(--shadow-l) flex flex-col gap-13 px-20 py-5 xxlg:absolute xxlg:left-[25%] xxlg:top-[30%] xxlg:mt-10">
